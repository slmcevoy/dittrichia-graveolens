...
input="ditt_adapterfilt_hifiasm_l0_omnic.asm.hic.hap1.p_ctg.fa"
...
input="ditt_adapterfilt_hifiasm_l0_omnic.asm.hic.hap2.p_ctg.fa"
...
input="ditt_adapterfilt_hifiasm_l0_omnic.asm.hic.p_ctg.fa"
